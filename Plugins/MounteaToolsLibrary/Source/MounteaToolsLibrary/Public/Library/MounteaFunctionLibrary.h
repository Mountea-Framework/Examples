...
#pragma region Gameplay
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category="Mountea|Interaction", meta=(CompactNodeTitle="Gamepad Connected", Keywords="Gamepad Mountea Interaction Connected Attached"))
